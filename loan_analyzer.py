...
# Print the total value of the loans
    ...
    print(f"The total of all the loans is ${Total_Loan_Costs}")
...
z = loan.get("loan_price")
print(f"Future value is {x}")
print(f"The remaining months are {y}") 
...
f = new_loan.get("future_value")
g = new_loan.get("remaining_months")
h = new_loan.get("loan_price")

Discount_Rate = 0.2 
Present_value2 = (f) / (1 + Discount_Rate/12) ** (g)



# @TODO: Use the function to calculate the present value of the new loan given below.
#    Use an `annual_discount_rate` of 0.2 for this new loan calculation.
print(f"The present value of the loan is {Present_value2}")
